class Lexicon:
    Title_affectiveImagery = "Associations towards the Carbon Tax"
    ...
    attributes_sector = "<b>Carbon pricing sector</b> <br> The tax could be imposed in <b>general/ton of CO<sub>2</sub></b> on all emissions. That means that for each product the associated CO<sub>2</sub> emissions would be calculated and a tax would be applied. Alternatively, the tax could be imposed on products of <b>meat and dairy/ton of CO<sub>2</sub></b>, or on products related to <b>energy production/ton of CO<sub>2</sub></b>. The latter would include, for example, electricity, petrol or heating oil."
    attributes_price = "<b>Price per ton of CO<sub>2</sub> emissions</b> <br> Depending on the price per ton of CO<sub>2</sub> emissions, different outcomes in terms of carbon neutrality can be achieved. Carbon-neutral means, that no more CO<sub>2</sub> emissions are released into the atmosphere than can be taken out again. With a price of <b>$60 per ton of CO<sub>2</sub></b> carbon neutrality could be achieved past mid-century, around 2060. With a price of <b>$120 per ton of CO<sub>2</sub></b> carbon neutrality could be achieved by mid-century, around 2050."
    attributes_revenue = "<b>Revenue mechanism </b> <br> The money collected (revenue) by imposing a tax on carbon emissions could be either <b>paid back as a dividend</b> to each citizen. This would mean that social injustice could be balanced out, as people who cause high CO<sub>2</sub> emissions would also have to pay more tax, but the dividend would be the same for all citizens. In this way, people who cause few CO<sub>2</sub> emissions benefit from the tax contributions of those who emit a lot. Another option would be, that the revenue would be <b>reinvested in Carbon Dioxide Removal technologies</b>. These novel technologies are able to remove CO<sub>2</sub> from the atmosphere and therefore contribute to CO<sub>2</sub> reduction." 
    attributes_timing = "<b>Implementation timing</b> <br> The start of the policy packages could be <b>in 1 year</b> or <b>in 7 years</b>. The duration and effects (revenue, additional taxes) pertain to the period after the introduction of the measures. This refers to the starting point for the concrete implementation of the decided measures. That means, if a policy package is implemented in 7 years (by the end of 2030), CO<sub>2</sub> emissions will only be reduced from that point onward, and additional taxes will also be imposed from that time."
    button_info_CDR = "Further information can be opened "
