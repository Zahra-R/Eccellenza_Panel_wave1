class Lexicon:
    ...
    instructionCondition_telling_box_label_false = "Auf den nächsten Seiten finden Sie zwei Boxen. Jede Box enthält <b>Aussagen zum Klimawandel,</b> die von verschiedenen Quellen stammen."
    ...
    beliefHuman3Label = "Die Hauptursache des Klimawandels ist der Mensch."
