class Lexicon:
    ...
    food_dairy_A_to_B = '1-3 times weekly'
    food_dairy_B_to_C = '4-6 times weekly'
    food_dairy_C_to_D= '1-2 times daily '
    food_dairy_D_to_E = '2-4 times daily '
    food_dairy_more_than_E = 'More than four times daily'

 
    food_meat_label = 'How often do you eat meals containing meat or fish (e.g., spaghetti bolognese, salmon roll, etc.)? '
    food_meat_less_than_A = 'less than once per week or never '
    food_meat_A_to_B= '1-3 times weekly '
    food_meat_B_to_C = '4-6 times weekly'
    food_meat_C_to_D = 'once per day'
    food_meat_D_to_E = '2-3 times daily '
    food_meat_more_than_E = 'More than three times daily '
