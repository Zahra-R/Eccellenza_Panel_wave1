...
SESSION_CONFIGS = [
  ...
  #      app_sequence=['survey','task'],
         app_sequence=['FirstBlock',  'Nina_instructions', 'Nina_carbontask',  'Jessi_Instructions',  'Jessi_carbonTax','CCsampling_intro', 'CCsampling',  'Scales','CCsampling_Debrief'],
         language = "zh_hans",
         num_demo_participants=10,
     ),
      dict(
  ...
  #      app_sequence=['survey','task'],
         app_sequence=[ 'FirstBlock',  'Jessi_Instructions',  'Jessi_carbonTax', 'CCsampling_intro','Nina_instructions', 'Nina_carbontask',  'CCsampling', 'Scales','CCsampling_Debrief'],
         language = "en",
         num_demo_participants=10,
     ),
     dict(
