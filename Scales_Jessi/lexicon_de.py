class Lexicon:
    ...
    vocational_education = "Berufsausbildung"
    high_school = "Abitur"
    some_college = "Ein Teil an der Hochschule / Universität"
    bachelors_degree = "Hochschulabschluss - Bachelor"
    masters_degree = "Hochschulabschluss - Master"
