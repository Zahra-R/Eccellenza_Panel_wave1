class Lexicon:
    ...
    transitions_a = 'Thank you very much for your answers so far. If you need a short break before continuing with the study, now would be a good time. Once you click on the next button on this page, we ask you to please complete this block in one go.'
